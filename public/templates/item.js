...
jade.debug = [{ lineno: 1, filename: "/www/node/blarney-marionette/client/templates/item.jade" }];
try {
var buf = [];
...
buf.push("<input" + (jade.attrs({ 'type':("text"), 'name':("title"), 'value':("" + (item.title) + ""), "class": [('form-control'),('width-full'),('bold'),('large')] }, {"type":true,"name":true,"value":true})) + "/>");
jade.debug.shift();
jade.debug.unshift({ lineno: 5, filename: jade.debug[0].filename });
buf.push("<textarea name=\"content\" rows=\"10\" class=\"form-control width-full\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
