...
jade.debug = [{ lineno: 1, filename: "./client/templates/main.jade" }];
try {
var buf = [];
...
jade.debug.shift();
jade.debug.unshift({ lineno: 4, filename: jade.debug[0].filename });
buf.push("<table class=\"table striped\">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
...
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.unshift({ lineno: 17, filename: jade.debug[0].filename });
buf.push("<a" + (jade.attrs({ 'btn-danger':(true), 'href':("#/del/" + (item.id) + ""), "class": [('btn')] }, {"btn-danger":true,"href":true})) + ">");
jade.debug.unshift({ lineno: undefined, filename: jade.debug[0].filename });
jade.debug.shift();
buf.push("</a>");
jade.debug.shift();
